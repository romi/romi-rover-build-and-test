...
public:
        ...
        virtual bool CreateConfigurationFile(const std::string& json_configuration,
                                             const DeviceMap& devices,
                                             const std::string& ouput_file) = 0;
        [[nodiscard]] virtual std::string LoadConfiguration(const std::string& configuration_file) const = 0;
