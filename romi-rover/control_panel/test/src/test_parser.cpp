...
TEST_F(parser_tests, parser_returns_true_on_single_string_value)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        //Assert
        ASSERT_THAT(r, ElementsAre(false, false, false, false, false, false, false, true));
        ASSERT_EQ(parser.opcode(), 'a');
        ASSERT_EQ(parser.length(), 0);
...
TEST_F(parser_tests, parser_returns_true_on_array_with_single_string)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        //Assert
        ASSERT_THAT(r, ElementsAre(false, false, false, false, false, false, false, false, false, true));
        ASSERT_EQ(parser.opcode(), 'a');
        ASSERT_EQ(parser.length(), 0);
        ASSERT_EQ(parser.has_string(), 1);
        ASSERT_STREQ(parser.string(), "toto");
...
TEST_F(parser_tests, parser_returns_true_on_array_with_string_and_value)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        //Assert
        ASSERT_THAT(r, ElementsAre(false, false, false, false, false, false, false, false, false, false, false, true));
        ASSERT_EQ(parser.opcode(), 'a');
        ASSERT_EQ(parser.has_string(), 1);
        ASSERT_STREQ(parser.string(), "toto");
        ASSERT_EQ(parser.length(), 1);
...
TEST_F(parser_tests, parser_returns_true_on_array_with_value_and_string)
{
        // Arrange
        Parser parser("ab", "xy");
...
TEST_F(parser_tests, parser_returns_true_on_array_with_string_and_three_values)
{
        // Arrange
        Parser parser("ab", "xy");
...
TEST_F(parser_tests, parser_returns_true_on_array_with_three_values_and_string)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        //Assert
        ASSERT_THAT(r, ElementsAre(false, false, false, false, false, false, 
...
TEST_F(parser_tests, parser_returns_false_on_string_without_closing_quote)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        //Assert
        ASSERT_THAT(r, ElementsAre(false, false, false, false, false, false, false));
        ASSERT_THAT(e, ElementsAre(0, 0, 0, 0, 0, 0, parser_invalid_string));
        ASSERT_EQ(parser.length(), 0);
        ASSERT_EQ(parser.has_string(), 0);
}

TEST_F(parser_tests, parser_returns_false_on_long_string)
{
        // Arrange
        Parser parser("ab", "xy");
...
TEST_F(parser_tests, parser_returns_true_on_array_with_two_string)
{
        // Arrange
        Parser parser("ab", "xy");
        ...
        ASSERT_EQ(parser.length(), 0);
        ASSERT_EQ(parser.has_string(), 1);
        ASSERT_STREQ(parser.string(), "world");
}
