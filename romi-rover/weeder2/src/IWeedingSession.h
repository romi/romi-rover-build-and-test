...
#ifndef __ROMI_I_WEEDING_SESSION_H
#define __ROMI_I_WEEDING_SESSION_H
...
namespace romi {
        ...
        class IWeedingSession
        {
        public:
                virtual ~IWeedingSession() = default;
...
#endif // __ROMI_I_WEEDING_SESSION_H
