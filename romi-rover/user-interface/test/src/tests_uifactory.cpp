...
{
        JsonCpp config = JsonCpp::parse("{'display-classname': 'none'}");
...
{
        JsonCpp config = JsonCpp::construct("{'display-classname': '%s'}",
...
{
        JsonCpp config = JsonCpp::construct("{'navigation-classname': '%s'}",
...
{
        JsonCpp config = JsonCpp::parse("{'navigation-classname': 'foo'}");
        options.navigation_classname = 0;
